...
╰─────────────────────────╯
"
echo "Arch Linux Fast Install (ArchFiery) - Version: 2023.11.28 (GPL-3.0)"
sleep 6s
printf "\n"
...
# THIS WORKS SAME AS PIKAUR OR YAY
